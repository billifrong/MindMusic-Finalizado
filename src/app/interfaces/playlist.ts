...
export const ListaPlaylist:Array<Playlist>=[
    {
        ID: 1,
        Nombre: "Favoritos",
        Fecha: 2022,
        Imagen: "https://i.ytimg.com/vi/Wv2cjfZ-0bM/mqdefault.jpg",
        Duracion: "12:56",
        Musica: [{
    ...
    {
        ID: 2,
        Nombre: "Top Musica Relajante",
        Fecha: 2022,
        Imagen: "https://cdn-images-1.listennotes.com/podcasts/lavariega-radio/m%C3%BAsica-para-relajar-la-mente-HEQI9gCF8XZ-LwKcvBznM-U.1400x1400.jpg",
        Duracion: "7:29",
        Musica: [{
            Nombre: "2022",
